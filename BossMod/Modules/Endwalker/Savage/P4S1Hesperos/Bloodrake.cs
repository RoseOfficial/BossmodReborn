...
// AI component for automatic responses to Bloodrake (raidwide AOE)
class Bloodrake(BossModule module) : BossComponent(module)
{
    ...
    {
        if ((AID)spell.Action.ID == AID.Bloodrake)
        {
            _castStarted = true;
